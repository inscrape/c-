...
{
    public class FileConvertor : RecordsConvertor
    {
        public override Image Logo { get;  set; } = Properties.Resources.Document;
        public override string Title { get; set; } = "File Convertor";
        public override string Description { get; set; } = "Convert all files to the available export formats";
